 ...
 */
router.post('/create' , meetingRoomController.createMeetingRoom);
 ...
 */
router.get('/' , meetingRoomController.getAvailableMeetingRooms);
 ...
 *         description: Meeting room not found
 */
router.post('/update/:id' , meetingRoomController.updateMeetingRoom);

/**
 * @swagger
 * /api/roomMeeting/delete/{id}:
 *   delete:
 ...
 *         description: Meeting room not found
 */
router.get('/delete/:id', meetingRoomController.deleteMeetingRoom);
/**
 * @swagger

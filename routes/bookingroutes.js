 ...
 */
router.post('/' , chekMiddleware.checkConflict, bookingController.reserveRoom);
 ...
 */
router.post('/update/:id' , chekMiddleware.checkConflict, bookingController.updateBooking);
 ...
 *         description: Booking not found
 */
router.get('/cancel/:id' , bookingController.cancelBooking);
